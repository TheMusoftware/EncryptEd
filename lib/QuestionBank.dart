...
class QuestionBank {
  ...
  List<Question> getVernamQuestions() {
    return [
      ...
      Question(
        question:
            'Какое математическое действие является центральным для шифра Вернама?',
      ...
      Question(
        ...
        options: [
          ...
          'Такая же, как и длина сообщения' // Update here
        ],
  ...
  List<Question> getCaesarQuestions() {
    return [
      ...
      Question(
        question:
            "Что произойдет с буквой 'Z' при сдвиге на 1 позицию в шифре Цезаря?",
        options: ['A', 'B', 'Y', 'Z'],
        answer: 0,
      ),
      Question(
      ...
      Question(
        question:
            "На сколько позиций сдвигаются буквы в шифре Цезаря в его самой простой форме?",
        options: ['1', '2', '3', '4'],
        answer: 2,
      ),
      Question(
  ...
  List<Question> getHillQuestions() {
    return [
      ...
      Question(
        question:
            'Каким свойством должна обладать ключевая матрица в шифре Хилла?',
        options: [
      ...
      Question(
        question:
            'Шифрование по методу Хилла опирается на какой математический концепт?',
        options: [
