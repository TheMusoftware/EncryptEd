          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                children: List.generate(1, (index) {
                  return Container(
                    ...
                    child: Text(
                      ['Не завершено принятие стандартов'][index],
                      // Текст внутри
              ...
              Column(
                ...
                children: List.generate(1, (index) {
                  return Container(
                    ...
                    child: Text(
                      ['Нет расширений для отечественной криптографии'][index],
                      // Текст внутри
                      style: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
              ...
              Column(
                ...
                children: List.generate(1, (index) {
                  return Container(
                    ...
                    child: Text(
                      ['22 мероприятия, разделенные на три группы:'][index],
                      // Текст внутри
                      style: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
              ...
              Card(
                ...
                shape: RoundedRectangleBorder(
                  borderRadius:
                      BorderRadius.circular(10), // Закругляем углы карточки
                ),
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Column(
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text:
                                  ' - требования безопасности к ПО криптографической защиты.',
                              style: TextStyle(
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text:
                                  ' - шифрование, хэширование, управление ключами.',
                              style: TextStyle(
                                  fontSize: 14.0, color: Colors.black),
                            ),
                          ],
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text:
                                  ' - ЭЦП и транспорт ключей на основе эллиптических кривых.',
                              style: TextStyle(
                                  fontSize: 14.0, color: Colors.black),
                            ),
                          ],
              ...
              Column(
                ...
                children: List.generate(1, (index) {
                  return Container(
                    ...
                    child: Text(
                      [
                        'Нереализованны 7 мероприятия, из них важнейшие:'
                      ][index], // Текст внутри
                      style: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text:
                                  ' - необходимо принять стандарт на использование протокола TLS с криптонаборами на отечественных алгоритмах. '
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text:
                                  ' - необходимо разработать стандарт для протоколов аутентификации и выработки общего ключа с использованием эллиптических кривых. '
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text:
                                  ' - необходимо принять стандарт для функций хэширования с 384- и 512-битовыми значениями, что позволяет значительно '
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                              text:
                                  ' - требуется принять стандарт для алгоритма шифрования с низкой ресурсоемкостью, специально предназначенного для '
