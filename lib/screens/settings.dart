        ...
        child: ListView(
          children: [
            ...
            _buildSettingCard(
              ...
              title: 'О криптографической стандартизации в РБ',
              description: 'В Беларуси криптографическая стандартизация началась в 1999 году, когда...',

              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Standartization(),
                  )
                );
